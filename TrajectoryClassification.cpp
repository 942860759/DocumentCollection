...
#define MAX 200
#define pi 3.1415926
const int M = 13;// 全部M个人轨迹
const double w0 = pi / 2;//转角阈值
const double e0 = 0.8;//近邻阈值
...
struct Trajectory {
	...
	{11,{{1,3},{3,4},{4,5},{6,6},{7,9},{9,8},{10,6},{9,4},{8,3},{6,2},{3,1}}},
	{7,{{1,4},{3,6},{5,7},{6,10},{8,6},{7,4},{4,3}}},
	{12,{{2,2},{3,4},{4,5},{5,7},{6,8},{7,10},{9,11},{10,13},{11,11},{12,10},{13,8},{11,6}}},
	{8,{{3,3},{4,6},{5,8},{7,7},{9,8},{10,6},{9,4},{10,2}}},
	{11,{{1,1},{2,2},{3,4},{5,3},{8,4},{7,6},{8,7},{11,6},{10,8},{12,9},{14,7}}},
	{9,{{1,1},{2,4},{5,5},{7,3},{6,5},{8,6},{9,8},{11,10},{12,7}}},
	{11,{{1,1},{3,2},{4,1},{6,2},{5,4},{6,7},{4,9},{3,11},{2,9},{1,8},{0,6}}},
	{8,{{1,4},{2,6},{5,7},{7,8},{8,6},{6,4},{3,3},{1,1}}},
};
...
void Algorithm() {
	...
	for (int i = 0; i<m; i++) {
		cout << "center " << cluster[i].centerOrbit.attribute << "(" << cluster[i].centerOrbit.pointF.x << ","
		...
		for (int j = 0; j<cluster[i].n - 1; j++)
			cout << cluster[i].otherOrbit[j].attribute << "(" << cluster[i].otherOrbit[j].pointF.x << ","
